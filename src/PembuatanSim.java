...
class PembuatanSim extends JFrame
{
 JLabel lblnama=new JLabel("Nama Pendaftar :");
 JTextField txnama=new JTextField(20);
 JLabel lblnim=new JLabel("Alamat:");
 ...
 JRadioButton ganda=new JRadioButton("Ganda");
 ButtonGroup kelompok=new ButtonGroup();
 JLabel lblhobi=new JLabel("Sim Yang Dibuat:");
 JCheckBox baca=new JCheckBox("Sim A");
 JCheckBox mancing=new JCheckBox("Sim B");
 JCheckBox jalan=new JCheckBox("Sim C");
...
wanita.setBounds(160,56,70,20);
 ...
 {
 PembuatanSim S5=new PembuatanSim();
 S5.KomponenVisual();
 S5.AksiReaksi();
 }
}